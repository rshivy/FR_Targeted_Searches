...
if __name__ == '__main__':
    ...
    PARSER.add_argument('-hm', '--human', action='store',
                        type=str, dest='human', default=getpass.getuser())
    ...
    args.dataset = 'ng15_v1p1'
    args.source_name = 'ZTF18abxxohm'
    args.noisedict = '15yr_wn_dict'
    args.psrdists = 'pulsar_distances_15yr'
    args.upper_limit = True

    if getpass.getuser() in ['frh7', 'forrest']:
        args.human = 'F Hutchison'
    elif getpass.getuser() in ['rjs235', 'rohan']:
        args.human = 'R Shivakumar'
    ...
    if args.source_name is None or args.source_name == 'no_cw':
