...
#     "DEC": "+64d29m23.578s",
#     "log10_dist": 2.887,                 <-- log of the distance to source in Mpc
#     "log10_freq": -7.348469980409295     <-- log of the GW frequency to look for
# Here I set the frequency equal to the variability period from the SIMBAD data
# I don't know if that is really justified, but setting it now reduces the parameters we have to search over
